...
export const PREVIEW_MODES = [
  { name: "Desktop", width: "100%", icon: <ComputerDesktopIcon className="w-5 h-5" /> },
  { name: "Tablet", width: "768px", icon: <DeviceTabletIcon className="w-5 h-5" /> },
  { name: "Mobile", width: "375px", icon: <DevicePhoneMobileIcon className="w-5 h-5" /> },
];
