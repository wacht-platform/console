...
const styles = {
  base: [
    ...
    "focus:outline-hidden data-focus:outline data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-indigo-500 dark:data-focus:outline-indigo-400",
  ...
  colors: {
    ...
    indigo: [
      ...
      "dark:[--btn-bg:var(--color-indigo-500)] dark:[--btn-border:var(--color-indigo-600)]/90",
    ...
    red: [
      "text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-red-600)] [--btn-border:var(--color-red-700)]",
      "[--btn-icon:var(--color-white)] data-active:[--btn-icon:var(--color-red-100)] data-hover:[--btn-icon:var(--color-red-100)]",
    ],
    orange: [
...
export const Button = forwardRef(function Button(
  ...
  const classes = clsx(
    ...
    outline
      ...
      : plain
        ? styles.plain
        : clsx(styles.solid, styles.colors[color ?? "indigo"]),
  );
