...
export function DomainManagement({ organizationId }: DomainManagementProps) {
    ...
    const [deletingDomainId, setDeletingDomainId] = useState<string | null>(
        null,
    );
    ...
    const verificationRecord =
        selectedDomain?.verification_dns_record_data ||
    ...
    const handleVerify = async (domainId?: string) => {
        ...
        const idToVerify =
            typeof domainId === "string" ? domainId : selectedDomain?.id;
    ...
    return (
        <div className="space-y-4">
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            configuration to verify ownership of{" "}
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                ...
                                                strokeWidth={2}
                                                d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 012-2h2a2 2 0 012 2m-6 4h6m-6 4h6"
                                            />
                                        </svg>
                                    </Button>
                                </div>
            ...
            <Dialog
                open={!!deletingDomainId}
                onOpenChange={(val) => !val && setDeletingDomainId(null)}
            >
                <DialogContent>
                    <DialogHeader>
