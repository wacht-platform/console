...
export const tours = {
    ...
    "first-ai-settings": {
        id: "first-ai-settings",
        version: 1,
        title: "AI configuration",
        mode: "linear",
        intro: {
            title: "Configure your agent runtime",
            body: "This page controls deployment-level storage, model routing, provider keys, and OpenAI profiles that agents can use.",
            primaryLabel: "Walk me through",
        },
        steps: [
            {
                ...
                title: "Configuration",
                body: "This tab is where deployment-wide agent runtime configuration lives.",
                side: "bottom",
                align: "center",
            },
            {
                target: "ai-settings-storage",
                title: "Storage",
                body: "Configure the S3-compatible bucket agents use for workspaces, uploads, and vector artifacts.",
                side: "top",
                align: "center",
            },
            {
                target: "ai-settings-models",
                title: "Model routing",
                body: "Set the deployment defaults for strong reasoning calls and cheaper weak-model calls.",
                side: "top",
                align: "center",
            },
            {
                target: "ai-settings-provider-keys",
                title: "Provider keys",
                body: "Add deployment-level Gemini, OpenRouter, or OpenAI keys. Leave a field blank to keep the saved key.",
                side: "top",
                align: "center",
            },
            {
                target: "ai-settings-openai-profiles",
                title: "OpenAI profiles",
                body: "Create per-agent OpenAI profiles when selected agents need separate keys, endpoints, projects, or default models.",
                side: "top",
                align: "center",
            },
        ],
