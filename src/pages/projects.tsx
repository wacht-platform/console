          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-muted-foreground md:text-base">
                Centralize every app and deployment environment in one control
                plane.
              </p>
            </div>
        ...
        <section className="mt-7">
          <Tabs defaultValue="all" className="w-full">
            <TabsList className="h-10 rounded-xl border border-border/80 bg-muted/40 p-1">
              <TabsTrigger value="all" className="h-8 rounded-lg px-4 text-xs">
                All
              </TabsTrigger>
              <TabsTrigger
                value="production"
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              <Text>
                Your billing account has been created but the subscription
                payment has not been completed yet.
              </Text>
              <ul className="mt-3 list-inside list-disc space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
                <li>You closed checkout before finishing payment</li>
                <li>The payment may still be processing</li>
                <li>There may be an issue with your payment method</li>
              </ul>
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
  ...
  return (
    ...
    >
      <div className="grid gap-3 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_160px_120px_130px_28px] md:items-center">
        ...
        <p className="text-xs text-muted-foreground">{deployments.length}</p>
