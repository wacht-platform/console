            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-zinc-500 dark:text-zinc-500 text-sm font-light max-w-xl mb-4 leading-relaxed">
                  For large-scale deployments requiring dedicated support,
                  custom contracts, and unlimited volume. Get tailored SLA
                  guarantees and on-premise deployment options.
                </p>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-zinc-500 dark:text-zinc-500 text-sm font-light max-w-xl mb-4 leading-relaxed">
                ...
                contracts, and unlimited volume. Get tailored SLA guarantees and
