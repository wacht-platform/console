...
export default function EmailNewSignUpPage() {
...
<div style="font-family: Helvetica, Arial, sans-serif; max-width: 90%; margin: auto; line-height: 1.6; color: #333; padding: 20px; box-sizing: border-box;">
  <div style="margin: auto; padding: 20px; background: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div style="text-align: center;">
      <a href="[action_url]" style="background: #000; color: #fff; padding: 12px 24px; border-radius: 5px; text-decoration: none; font-size: 1.2em; display: inline-block;">Confirm Email</a>
    </div>
    <p style="margin-bottom: 20px;">
      If you didn't sign up for [app.name], you can safely ignore this email.
    </p>
...
`;
  ...
  return (
    <div className="flex flex-col gap-2 mb-2">
      <Heading className="mb-8">New Signup</Heading>
        ...
        <div className="space-y-10">
          ...
          <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div>
              <Input
                type="text"
                placeholder="Welcome to [app.name]! Confirm Your Email"
                size={29}
              />
            </div>
          </section>
