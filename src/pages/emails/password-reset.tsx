...
<div style="font-family: Helvetica, Arial, sans-serif; max-width: 90%; margin: auto; line-height: 1.6; color: #333; padding: 20px; box-sizing: border-box;">
  <div style="margin: auto; padding: 20px; background: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <p style="margin-bottom: 20px;">
      You recently requested to reset your password for your [app.name] account. Click the button below to reset it:
    </p>
    <div style="text-align: center;">
      <a href="[action_url]" style="background: #000; color: #fff; padding: 12px 24px; border-radius: 5px; text-decoration: none; font-size: 1.2em; display: inline-block;">Reset Password</a>
    </div>
    <p style="margin-bottom: 20px;">
      This password reset link will expire in [password_reset.expires_in_minutes] minutes. If you did not request a password reset, please ignore this email.
    </p>
...
`;
  ...
  return (
    <div className="flex flex-col gap-2 mb-2">
      <Heading className="mb-8">Password Reset</Heading>
        ...
        <div className="space-y-10">
          ...
          <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div>
              <Input
                type="text"
                placeholder="Reset Your Password for [app.name]"
                size={29}
              />
            </div>
          </section>
